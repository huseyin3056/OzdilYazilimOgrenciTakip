...
{
    public partial class RenkBedenSiparisBilgileriTable : BaseTablo
    {
        public RenkBedenSiparisBilgileriTable()
        {
            InitializeComponent();

            Bll = new RenkBedenSiparisBilgileriBll();

            Tablo = tablo;
            EventsLoad();


           // repositoryItemImageComboBoxKur.Items.AddEnum<Kur>();
        }

        protected internal override void Listele()
        {
            tablo.GridControl.DataSource = ((RenkBedenSiparisBilgileriBll)Bll).List(x=>x.SiparisId==OwnerForm.Id).ToBindingList<RenkBedenSiparisBilgileriL>();
        ...
        protected override void HareketEkle()
        {
            ...
            var row = new RenkBedenSiparisBilgileriL
            {
                SiparisId = OwnerForm.Id,
                Insert = true,
        ...
        protected override void SutunGizleGoster()
        {
            ...
            var entity = tablo.GetRow<RenkBedenSiparisBilgileriL>();
            if (entity == null) return;

            SutunIndeksDuzenle();

            var beden = ((RenkBedenSiparisEditForm)OwnerForm).txtBeden.Text;
            ...
            foreach (var item in value)
            {
                ...
                if (item == "42")
                {
                    col42.VisibleIndex = 20;
                    colToplam.VisibleIndex = 100;
                    col42.Visible = true;
                }
                if (item == "44")
                {
                    col44.VisibleIndex = 21;
                    colToplam.VisibleIndex = 100;
                    col44.Visible = true;
                }
                if (item == "46")
                {
                    col46.VisibleIndex = 22;
                    colToplam.VisibleIndex = 100;
                    col46.Visible = true;
                }
                if (item == "48")
                {
                    col48.VisibleIndex = 23;
                    colToplam.VisibleIndex = 100;
                    col48.Visible = true;
                }
                if (item == "50")
                {
                    col50.VisibleIndex = 24;
                    colToplam.VisibleIndex = 100;
                    col50.Visible = true;
                }
        ...
        private void SutunIndeksDuzenle()
        {
            ...
            col60.VisibleIndex = 29;
            col62.VisibleIndex = 30;
            col64.VisibleIndex = 31;
            col66.VisibleIndex = 32;
        ...
        private void ToplamHesapla(RenkBedenSiparisBilgileriL entity)
        {
        ...
        protected internal override bool HataliGiris()
        {
            ...
            {
                var entity = tablo.GetRow<RenkBedenSiparisBilgileriL>(i);
