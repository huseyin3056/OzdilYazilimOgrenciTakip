...
namespace OzdilYazilimOgrenciTakip.UI.Win.GenelForms
{
    public partial class SubeDonemSecimiEditForm : BaseEditForm
    {
        ...
        public SubeDonemSecimiEditForm(params object[] prm)
        {
            ...
            HideItems = new DevExpress.XtraBars.BarItem[] { btnyeni, btnSil, btnGeriAl,btnKaydet,btnFarkliKaydet };
            ShowItems = new DevExpress.XtraBars.BarItem[] { btnGiris };
        ...
        public override void Yukle()
        {
            ...
            {
                var yetkiler = bll.List(x => x.KullaniciId == _kullaniciId).Cast<KullaniciBirimYetkileriL>();
                ...
                {
                    Messages.HataMesaji("Kullanıcı hiç bir şubede yetkilendirilediği için giriş yapamazsınız");
                ...
                {
                    Messages.HataMesaji("Kullanıcı hiç bir dönemde yetkilendirilmediği için giriş yapamazsınız");
                    Application.ExitThread();
        ...
        public override void Giris()
        {
            ...
            using (var bll = new DonemParametreBll())
            {
                ...
                if (entity == null)
                {
                    Messages.HataMesaji("Seçtiğiniz Şubenin İlgili Dönemine Ait Parametreler Girilmemiş. Lütfen Sistem Yönetcinize Başvurun.");
                    return;
                }
